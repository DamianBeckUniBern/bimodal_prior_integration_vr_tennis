...
model_fast <- lm(horizontal_difference ~ ball_position, data = fast)
summary(model_fast)
...
#Outlier detection with cooks distance 
#if more than 3 times more influential than an average point
model_moderate <- lm(horizontal_difference ~ ball_position, data = moderate)
...
#Outlier detection with cooks distance 
#if more than 3 times more influential than an average point
model_slow <- lm(horizontal_difference ~ ball_position, data = slow)
summary(model_slow)
...
create_bins_with_stats_all_subjects <- function(data) {
  bin_ranges <- list(
    ...
    c(56, 58), c(58, 60), 
    c(60, 62), c(62, 64), c(64, 66), c(66, 68),
    c(68, 70), c(70, 72), c(72, 74), c(74, 76),
    c(76, 78), c(78, 80),
    c(80, 82), c(82, 84),
...
p <- ggplot() +
  ...
  geom_segment(aes(x = 60,y = fixef(model5_fast)[1]+ 60*fixef(model5_fast)[2], xend = 70, yend = fixef(model5_fast)[1]+ 70*fixef(model5_fast)[2]), size = 2, alpha = 1,  color = "red", linetype = "solid") +
  geom_segment(aes(x = 70,y = fixef(model5_fast)[1]+ 70*fixef(model5_fast)[2]+fixef(model5_fast)[3], xend = 80, yend = fixef(model5_fast)[1]+ 80*fixef(model5_fast)[2]+fixef(model5_fast)[3]), size = 2, color = "red", linetype = "solid") +
  ...
  geom_segment(aes(x = 60, y = fixef(model5_moderate)[1] + 60 * fixef(model5_moderate)[2], xend = 70, yend = fixef(model5_moderate)[1] + 70 * fixef(model5_moderate)[2]), size = 2, alpha = 1, color = "blue", linetype = "solid") +
  geom_segment(aes(x = 70, y = fixef(model5_moderate)[1] + 70 * fixef(model5_moderate)[2] + fixef(model5_moderate)[3], xend = 80, yend = fixef(model5_moderate)[1] + 80 * fixef(model5_moderate)[2] + fixef(model5_moderate)[3]), size = 2, color = "blue", linetype = "solid") +
  ...
  geom_segment(aes(x = 60, y = fixef(model5_slow)[1] + 60 * fixef(model5_slow)[2], xend = 70, yend = fixef(model5_slow)[1] + 70 * fixef(model5_slow)[2]), size = 2, alpha = 1, color = "green", linetype = "solid") +
  geom_segment(aes(x = 70, y = fixef(model5_slow)[1] + 70 * fixef(model5_slow)[2] + fixef(model5_slow)[3], xend = 80, yend = fixef(model5_slow)[1] + 80 * fixef(model5_slow)[2] + fixef(model5_slow)[3]), size = 2, color = "green", linetype = "solid") +
...
p <- ggplot() +
  ...
  # Add segments for fast
  geom_segment(aes(x = 40,y = fixef(model4_fast)[1]+ 40*fixef(model4_fast)[2], xend = 60, yend = fixef(model4_fast)[1]+ 60*fixef(model4_fast)[2]), size = 2, color = "red", linetype = "solid") +
  geom_segment(aes(x = 80,y = fixef(model4_fast)[1]+ 80*fixef(model4_fast)[2], xend = 100, yend = fixef(model4_fast)[1]+ 100*fixef(model4_fast)[2]), size = 2, color = "red", linetype = "solid") +
  geom_segment(aes(x = 60,y = fixef(model4_fast)[1]+ 60*fixef(model4_fast)[2], xend = 70, yend = fixef(model4_fast)[1]+ 70*fixef(model4_fast)[2]), size = 2, alpha = 1,  color = "red", linetype = "solid") +
  geom_segment(aes(x = 70,y = fixef(model4_fast)[1]+ 70*fixef(model4_fast)[2], xend = 80, yend = fixef(model4_fast)[1]+ 80*fixef(model4_fast)[2]), size = 2, color = "red", linetype = "solid") +
  # Add similar segments for moderate
  geom_segment(aes(x = 40, y = fixef(model4_moderate)[1] + 40 * fixef(model4_moderate)[2], xend = 60, yend = fixef(model4_moderate)[1] + 60 * fixef(model4_moderate)[2]), size = 2, color = "blue", linetype = "solid") +
  geom_segment(aes(x = 80, y = fixef(model4_moderate)[1] + 80 * fixef(model4_moderate)[2] , xend = 100, yend = fixef(model4_moderate)[1] + 100 * fixef(model4_moderate)[2]), size = 2, color = "blue", linetype = "solid") +
  geom_segment(aes(x = 60, y = fixef(model4_moderate)[1] + 60 * fixef(model4_moderate)[2], xend = 70, yend = fixef(model4_moderate)[1] + 70 * fixef(model4_moderate)[2]), size = 2, alpha = 1, color = "blue", linetype = "solid") +
  geom_segment(aes(x = 70, y = fixef(model4_moderate)[1] + 70 * fixef(model4_moderate)[2] , xend = 80, yend = fixef(model4_moderate)[1] + 80 * fixef(model4_moderate)[2]), size = 2, color = "blue", linetype = "solid") +
  # Add similar segments for slow
  geom_segment(aes(x = 40, y = fixef(model4_slow)[1] + 40 * fixef(model4_slow)[2], xend = 60, yend = fixef(model4_slow)[1] + 60 * fixef(model4_slow)[2]), size = 2, color = "green", linetype = "solid") +
  geom_segment(aes(x = 80, y = fixef(model4_slow)[1] + 80 * fixef(model4_slow)[2] , xend = 100, yend = fixef(model4_slow)[1] + 100 * fixef(model4_slow)[2]), size = 2, color = "green", linetype = "solid") +
  geom_segment(aes(x = 60, y = fixef(model4_slow)[1] + 60 * fixef(model4_slow)[2], xend = 70, yend = fixef(model4_slow)[1] + 70 * fixef(model4_slow)[2]), size = 2, alpha = 1, color = "green", linetype = "solid") +
  geom_segment(aes(x = 70, y = fixef(model4_slow)[1] + 70 * fixef(model4_slow)[2] , xend = 80, yend = fixef(model4_slow)[1] + 80 * fixef(model4_slow)[2]), size = 2, color = "green", linetype = "solid") +
