...
#exclude familiarization trials (warm up)
data_all <- data_all %>% filter(trial_number > 96)
...
percentage_of_no_hits #percentage of no hits is 13.18
...
percentage_of_backswing_hits #percentage of backswing hits is 2.59%
